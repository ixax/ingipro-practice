...
class Viewer {
    constructor(domElement) {
        ...
        mediator.on('viewer:change', this._newCameraPos.bind(this));
    }
    _newCameraPos(ev) {
        this._camera = ev.camera;
    }
    create3dScene() {
    ...
    handleFileSelect(evt) {
        ...
        reader.onload = (theFile => this._loader.load(theFile.target.result, this.loadObj.bind(this)));
        reader.readAsDataURL(file);
    }

    renderPhone() {
        mediator.emit('viewer:change', {camera: this._camera});
